...
export default function TicketView() {
  ...
  const handlePrint = async () => {
    ...
    setIsGenerating(true);
    try {
      await printPdf(element, `OS-${ticket.id}`);
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10">
        ...
        <div className="border-b border-zinc-900 pb-6 mb-8 flex justify-between items-start break-inside-avoid page-break-inside-avoid">
          ...
          <div className="text-right">
            <div className="mb-6">
              <p className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-1">Data da OS</p>
              <p className="text-xl font-black text-zinc-900">{safeFormatDate(ticket.date)}</p>
            </div>
            <div>
              <p className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-1">Técnico Responsável</p>
        ...
        {client && (
          <div className="mb-10 bg-white p-6 rounded-2xl border border-zinc-900 break-inside-avoid page-break-inside-avoid">
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-6">
              ...
              <div className="break-inside-avoid">
                <p className="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-1">E-mail</p>
        ...
        {ticket.reportedBy && (
          <div className="mb-10 bg-white p-6 rounded-2xl border border-zinc-900 break-inside-avoid page-break-inside-avoid">
            <h3 className="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-4 border-b border-zinc-900 pb-2">Relatado por (QR Code)</h3>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-0.5">Nome / Unidade</p>
                ...
                {ticket.budgetAmount && (
                  <div className="flex items-center gap-4 border-l border-zinc-200 pl-8">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-0.5">Orçamento Aprovado</p>
        ...
        <div className="space-y-10">
          {ticket.type === 'CORRETIVA' ? (
            <>
              <div className="break-inside-avoid page-break-inside-avoid bg-white p-6 rounded-2xl border border-zinc-900">
                <h3 className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-3 border-b border-zinc-900 pb-2">Problema Relatado</h3>
                <p className="text-zinc-800 whitespace-pre-wrap text-lg leading-relaxed">{ticket.reportedProblem}</p>
              </div>

              <div className="break-inside-avoid page-break-inside-avoid bg-white p-6 rounded-2xl border border-zinc-900">
                <h3 className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-3 border-b border-zinc-900 pb-2">Relato da Ordem de Serviço</h3>
                <p className="text-zinc-800 whitespace-pre-wrap text-lg leading-relaxed">{ticket.serviceReport || '.'}</p>
              </div>
            </>
          ) : (
            <div className="break-inside-avoid page-break-inside-avoid bg-white p-6 rounded-2xl border border-zinc-900">
              <h3 className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-4 border-b border-zinc-900 pb-2">Resultados do Checklist</h3>
              <div className="overflow-hidden border border-zinc-900 rounded-2xl">
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
                    <tr className="bg-zinc-50 text-zinc-900">
                      <th className="p-4 font-black uppercase tracking-widest border-b border-zinc-900">Tarefa</th>
                      <th className="p-4 font-black uppercase tracking-widest border-b border-zinc-900 w-24 text-center">Status</th>
                      <th className="p-4 font-black uppercase tracking-widest border-b border-zinc-900">Observações</th>
                    </tr>
                  </thead>
          ...
          {ticket.observations && (
            <div className="break-inside-avoid page-break-inside-avoid bg-white p-6 rounded-2xl border border-zinc-900">
              <h3 className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-3 border-b border-zinc-900 pb-2">Observações Gerais</h3>
          ...
          <div className="break-inside-avoid page-break-inside-avoid bg-white p-6 rounded-2xl border border-zinc-900">
            <h3 className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-4 border-b border-zinc-900 pb-2 flex items-center gap-2">
        ...
        <div className="mt-20 grid grid-cols-2 gap-20 break-inside-avoid page-break-inside-avoid no-break">
          <div className="text-center">
            ...
            <p className="font-black text-zinc-900 uppercase tracking-widest text-xs">{ticket.technician}</p>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest mt-1">Técnico Responsável</p>
          </div>
          <div className="text-center">
            <div className="w-full h-px bg-zinc-900 mb-4"></div>
            <p className="font-black text-zinc-900 uppercase tracking-widest text-xs">{client.name}</p>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest mt-1">Cliente / Síndico(a)</p>
          </div>
        </div>

        {/* Fotos do Serviço (Anexos) */}
        {(ticket.images?.length || 0) > 0 || ticket.photoBefore ? (
          <div className="mt-20 page-break-before-always bg-white p-6 rounded-2xl border border-zinc-900">
            <h3 className="text-xs font-black text-zinc-900 uppercase tracking-widest mb-6 border-b border-zinc-900 pb-2">Anexo: Fotos do Serviço</h3>
